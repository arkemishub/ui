...
const classNames = {
  json: cn(
    ...
    "px-0 bg-transparent min-h-[100px] [&_.monaco-editor]:rounded-theme [&_.margin]:rounded-bl-theme [&_.margin]:rounded-tl-theme [&_.monaco-scrollable-element]:rounded-br-theme [&_.monaco-scrollable-element]:rounded-tr-theme",
    "json"
  ),
  label: cn(sharedClassNames.label, "json__label"),
};
...
function Json({
  ...
  return (
    <div data-testid="arke-json">
      ...
      <div>
        <Editor
          className={cn(classNames.json, className)}
          value={value}
          height={height}
