...
describe("Alert", () => {
  ...
  it("should render error alert", () => {
    ...
    expect(screen.getByRole("presentation")).toHaveClass("alert--error");
  });

  it("should render warning alert", () => {
    render(<Alert color="warning">Alert</Alert>);
    expect(screen.getByRole("presentation")).toHaveClass("alert--warning");
  });

  it("should render info alert", () => {
    render(<Alert color="info">Alert</Alert>);
    expect(screen.getByRole("presentation")).toHaveClass("alert--info");
  });

  it("should render success alert", () => {
    render(<Alert color="success">Alert</Alert>);
    expect(screen.getByRole("presentation")).toHaveClass("alert--success");
  });
});
